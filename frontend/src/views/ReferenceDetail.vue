...
>
  <!-- PASS -->
  <CheckCircle v-if="finalCreditStatus === 'PASS'" class="w-4 h-4" />

  <!-- FAIL -->
  <XCircle v-else-if="finalCreditStatus === 'FAIL'" class="w-4 h-4" />
  ...
  Credit: {{ finalCreditStatus }}
            ...
            <span v-if="application_flags.sanctions_check.show"
              ...
              <CheckCircle v-if="application_flags.sanctions_check.risk_level === 'clear'" class="w-4 h-4" />
        ...
        <div v-if="showGuarantorRequiredBanner"
          ...
          <div class="flex items-start">
            <AlertTriangle class="w-5 h-5 text-amber-600 mt-0.5 mr-3 flex-shrink-0" />
            <div class="flex-1">
        ...
        <div v-if="reference.is_guarantor && parentReference"
          ...
          <div class="flex items-start">
            <ShieldCheck class="w-5 h-5 text-purple-600 mt-0.5 mr-3" />
            <div class="flex-1">
            ...
            <div v-for="(child, index) in childReferences" :key="child.id"
              ...
              <button @click="toggleTenantExpanded(child.id)"
                ...
                <div class="flex items-center gap-4 flex-1 text-left">
                  <ChevronRight class="w-5 h-5 text-gray-400 transition-transform"
                    :class="{ 'rotate-90': expandedTenant === child.id }" />
                  <div class="flex-1">
          ...
          <div v-if="reference.rtr_verified && reference.rtr_verification_data" class="mt-4 border-t pt-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div v-if="reference.rtr_verification_data.expiryDate">
                <label class="block text-sm font-medium text-gray-500">Expiry Date</label>
                <p class="mt-1 text-gray-900">{{ formatDate(reference.rtr_verification_data.expiryDate) }}</p>
              </div>
            </div>
          </div>
