      ...
      <div class="p-4 space-y-3">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
          ...
          <ol class="text-xs text-blue-700 dark:text-blue-400 space-y-1 list-decimal list-inside">
            <li>If you don't have a mydeposits account, register at <strong>mydeposits.co.uk</strong></li>
            <li>Click "Link mydeposits Account" below to authorize via OAuth</li>
            <li>Need help? Email <strong>dev@propertygoose.co.uk</strong> — we'll get you hooked up the same day!</li>
          </ol>
        </div>
      </div>
    </div>
