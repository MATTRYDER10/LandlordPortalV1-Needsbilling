...
router.post('/', authenticateToken, async (req: AuthRequest, res) => {
  try {
    ...
    const agreementData: AgreementData = {
      ...
      billsIncludedUtilities,
      hasOilTank: hasOilTank || false,
      hasSepticTank: hasSepticTank || false,
...
router.post('/:id/generate', authenticateToken, async (req: AuthRequest, res) => {
  try {
    ...
    const agreementData: AgreementData = {
      ...
      hasOilTank: agreement.has_oil_tank || false,
      hasSepticTank: agreement.has_septic_tank || false,
    ...
    const pdfData: AgreementPDFData = {
      ...
      paymentReference: agreementData.paymentReference,
      ...
      hasOilTank: agreementData.hasOilTank,
      hasSepticTank: agreementData.hasSepticTank,
...
router.put('/:id', authenticateToken, async (req: AuthRequest, res) => {
  try {
    ...
    const updatePayload: Record<string, any> = {
        ...
        agent_signs_on_behalf: agentSignsOnBehalf || false,
...
router.post('/:id/recall-and-edit', authenticateToken, async (req: AuthRequest, res) => {
  try {
    ...
    const agreementData: AgreementData = {
      ...
      paymentReference: req.body.paymentReference || originalAgreement.payment_reference,
