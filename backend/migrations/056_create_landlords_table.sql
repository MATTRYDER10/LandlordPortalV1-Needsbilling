...
-- This migration creates the landlords table for storing landlord details

-- ============================================================================
-- LANDLORDS TABLE
-- Stores landlord information including personal details, addresses, bank details, and properties
-- ============================================================================
CREATE TABLE IF NOT EXISTS landlords (
  ...
  company_name_encrypted TEXT, -- If is_company is true
  ...
  -- AML Check Status
  aml_status VARCHAR(50) DEFAULT 'not_requested', -- 'not_requested', 'requested', 'satisfactory', 'unsatisfactory'
  ...
  verification_status VARCHAR(50) DEFAULT 'pending', -- 'pending', 'submitted', 'verified', 'failed'
...
-- RLS Policy: Company members can insert landlords for their company
...
-- RLS Policy: Company members can update landlords from their company
...
-- RLS Policy: Company members can delete landlords from their company
...
-- Stores properties associated with landlords
-- ============================================================================
CREATE TABLE IF NOT EXISTS landlord_properties (
  ...
  -- Property Details
  property_type TEXT, -- 'flat', 'house', 'bungalow', 'studio', etc.
